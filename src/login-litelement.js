    ...
    return html` <div class="principal">
      <div class="login-container">
        ...
        <div class="login-form" style="text-align: center;">
          <h2 class="text-small">¡Bienvenido!</h2>
          <h2 class="text-medium">Iniciar sesión</h2>
          <form id="formulario">
            ...
            <div class="form-group" style="margin-top: 30px;">
              <button @click="${this._login}" class="login-button">
                Iniciar
              </button>
            </div>
          </form>
          ...
          <a href="#" style="margin-top: 5px;">Crear cuentas</a>
        </div>
      </div>
    </div>`;
  }
